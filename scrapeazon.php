...
// Make sure transients get cleaned up appropriately if necessary
add_action( 'edit_post', array(&$szShcd,'szDeleteTransient') );
add_action( 'deleted_post', array(&$szShcd,'szDeleteTransient') );
